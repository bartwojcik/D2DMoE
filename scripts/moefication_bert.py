...
def main():
    ...
    common_args.model_args.model_name_or_path = 'relu-bert-base-uncased'  # for our relu-finetuned bert
    # common_args.model_args.model_name_or_path = 'bert-base-uncased' # for standard gelu bert
    ...
    # Skip because we are using ReLU-pretrained bert

    # ════════════════════════ moe split════════════════════════ #
    moefication_split_args = deepcopy(base_model_args)
    ...
    moefication_split_args.base_on = base_exp_name
    ...
    moefication_routing_args.k_to_eval = [1, 2, 4, 8, 16, 32, 64]
    moefication_routing_args.eval_points = 3

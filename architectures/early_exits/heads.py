...
def transformer_standard_head_class(num_layers, hidden_dim=None):
    assert num_layers > 0
    ...
    return TransformerStandardHead


def transformer_cascading_head_class(num_layers, hidden_dim=None):
    assert num_layers > 0
    ...
    return TransformerCascadingHead
...
HEAD_TYPES = {
    ...
    'transformer_standard_head': transformer_standard_head_class(1),
    'transformer_2l_head': transformer_standard_head_class(2, 1024),
    'transformer_2l_2048_head': transformer_standard_head_class(2, 2048),
    'transformer_2l_4096_head': transformer_standard_head_class(2, 4096),
    'transformer_2l_8192_head': transformer_standard_head_class(2, 8192),
    'transformer_3l_head': transformer_standard_head_class(3, 8192),
    'transformer_4l_head': transformer_standard_head_class(4, 8192),
    'transformer_5l_head': transformer_standard_head_class(5, 8192),
    'transformer_cascading_head': transformer_cascading_head_class(1),
    'transformer_cascading_2l_head': transformer_cascading_head_class(2, 1024),
    'transformer_cascading_2l_2048_head': transformer_cascading_head_class(2, 2048),
    'transformer_cascading_2l_4096_head': transformer_cascading_head_class(2, 4096),
    'transformer_cascading_2l_8192_head': transformer_cascading_head_class(2, 8192),
    'transformer_cascading_3l_head': transformer_cascading_head_class(3, 8192),
    'transformer_cascading_4l_head': transformer_cascading_head_class(4, 8192),
    'transformer_cascading_5l_head': transformer_cascading_head_class(5, 8192),
